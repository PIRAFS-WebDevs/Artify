...
const RecentActivity = () => {
  return (
    <div
     ...
     "
    >
      <div className="lg:w-1/2 dark:bg-dark-400 p-5 overflow-x-auto rounded-sm border dark:border-dark-300 ">
      ...
      <div className="lg:w-1/2 dark:bg-dark-400 overflow-x-auto p-5 rounded-sm border dark:border-dark-300 ">
