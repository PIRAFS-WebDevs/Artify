...
const PreviewSvg = () => {
  ...
  return (
    ...
    >
      <div className="mb-2 flex items-center justify-center rounded-full hover:bg-primary bg-dark-100 text-light backdrop-blur-sm transition-all hover:bg-brand h-11 w-11">
        <svg
          viewBox="0 0 22 22"
          fill="none"
