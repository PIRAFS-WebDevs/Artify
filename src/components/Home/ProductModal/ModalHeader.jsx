...
const ModalHeader = ({ setIsShow }) => {
  ...
  return (
    <div className="flex justify-between gap-4 items-start lg:items-center dark:bg-dark-500 p-8">
      <div className="flex items-center flex-wrap gap-x-6">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <p className="dark:text-dark-100 text-sm">Qubitron Solutions</p>
          ...
          {like ? (
            ...
            <button onClick={() => setLike(true)}>
              <AiOutlineHeart className="w-6 h-6 dark:text-white cursor-pointer" />
            </button>
          )}
        </div>
      </div>
