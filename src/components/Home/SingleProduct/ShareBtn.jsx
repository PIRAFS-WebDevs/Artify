...
const ShareBtn = () => {
  return (
    <div className=" flex justify-between items-center gap-10">
      <button className="w-10 h-10 text-black hover:dark:bg-darkSec border border-bg-darkSec flex justify-center items-center rounded-full">
      ...
      <button className="w-auto h-10  px-5 group hover:dark:bg-darkSec border border-bg-darkSec flex justify-center items-center rounded-full">
