...
export default function ProductFooter() {
  return (
    <div className='md:sticky bottom-0 bg-darkPrimary py-4'>
        <div className='lg:flex justify-between '>
            <div>
                <div className='flex '>
                <h1 className='text-white font-bold text-lg'>Shoppie UI Kit PSD Ecommerce Design Template</h1>
                <AiOutlineHeart className='text-2xl mt-1 ml-3'/>
                </div>

                <div className='mt-3 flex gap-6 text-white'>
                    <div className='flex gap-2 items-center'>
                    <img src="https://pixer.redq.io/_next/image?url=https%3A%2F%2Fpixarlaravel.s3.ap-southeast-1.amazonaws.com%2F98%2Fconversions%2FGroup-14400-thumbnail.jpg&w=640&q=100"
                            alt=""
