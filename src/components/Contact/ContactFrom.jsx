    ...
    <div className=" xl:w-[60%] w-full p-10 text-xs dark:bg-dark-400">
      <form className="flex flex-col lg:gap-4  gap-2">
        ...
        <div>
          <button
            type="submit"
            className="block rounded bg-primary px-5 py-3 text-center text-sm font-semibold dark:text-white outline-none transition-all duration-100 hover:bg-primarySec md:text-sm active:scale-95"
          >
            Contact us
          </button>
        </div>
