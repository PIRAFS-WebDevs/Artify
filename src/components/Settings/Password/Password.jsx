...
export default function Password() {
  ...
  return (
    <div className="flex flex-col gap-6 text-dark-100">
      <p className="dark:text-light-100 text-dark-500">Password</p>
      ...
      >
        ...
        <div className="absolute self-end bottom-8">
          <button className="px-4 py-2 text-sm font-semibold text-light-100 transition-all duration-200 rounded-sm bg-primary hover:bg-primarySec active:scale-95">
            Save Changes
          </button>
        </div>
      </form>
